...
training_image_path=training_images/outdoor_seating
test_image_path=test_images/outdoor_seating
classes="has_outdoor_seating no_outdoor_seating" 
...
get_image_paths_py=outdoor_seating_csv_parse.py
...
setup_dirs() {
    echo "making links (this may take a few minutes)"
    get_image_paths
    for class in $classes
    do
        echo $class
