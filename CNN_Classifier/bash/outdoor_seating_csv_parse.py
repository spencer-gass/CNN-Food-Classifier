...
with open('has_outdoor_seating.txt','w') as efile, open('no_outdoor_seating.txt','w') as nfile:
    e_cnt, n_cnt = (0,0)
...
print('has outdoor_seating: ', str(e_cnt))
print('no outdoor_seating:  ', str(n_cnt))
