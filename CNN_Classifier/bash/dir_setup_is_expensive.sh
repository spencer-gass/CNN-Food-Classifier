...
training_image_path=training_images/is_expensive
test_image_path=test_images/is_expensive
classes="expensive inexpensive" 
...
get_image_paths_py=is_expensive_csv_parse.py
