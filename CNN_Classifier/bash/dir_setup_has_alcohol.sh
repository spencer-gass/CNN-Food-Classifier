...
training_image_path=training_images/has_alcohol
test_image_path=test_images/has_alcohol
classes="has_alcohol no_alcohol" 
...
get_image_paths_py=has_alcohol_csv_parse.py
